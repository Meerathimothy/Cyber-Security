...
i) dnsenum(domain nameserver enumeration)
  ...
  ii) dnsrecon
      This scrip twritten in python. It is used to perform a variety of function ranging from security enumeration to basic network         troubleshooting. It is used for Zone transfering(transfering DNS from one server to another) , domain and host bruteforce.
